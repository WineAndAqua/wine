...
static const WCHAR *hack_append_command_line( const WCHAR *cmd, const WCHAR *cmd_line )
{
    ...
    options[] =
    {
        ...
        {L"EpicGamesLauncher.exe", L" --in-process-gpu", NULL, L"--type=crashpad-handler"},
        {L"EpicOnlineServicesUIHelper", L" --in-process-gpu", NULL, L"--type=crashpad-handler"},
        {L"EOSOverlayRenderer-Win64-Shipping.exe", L" --in-process-gpu", NULL, L"--type=crashpad-handler"},
        {L"EACefSubProcess.exe", L" --in-process-gpu", NULL, L"--type=crashpad-handler"},
    };
    unsigned int i;
